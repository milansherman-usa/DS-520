...
week1_sleep[3] # assuming the week begins on Sunday and ends on Saturday
...
weekends <- days[which(!days %in% weekdays)]
...
assignments <- c("Assignment 1", "Assignment 2", "Assignment 3", "Assignment 4")
...
#or
sorted_characters_df <- characters_df %>% 
  arrange(age)
